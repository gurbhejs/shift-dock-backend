...
public interface IAssignmentService
{
    ...
    Task<IEnumerable<WorkerAssignmentResponse>> GetAssignmentsByProjectAsync(Guid organizationId, Guid projectId, Guid currentUserId, CancellationToken cancellationToken = default);
